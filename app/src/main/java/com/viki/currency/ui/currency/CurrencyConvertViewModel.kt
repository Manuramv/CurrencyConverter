...
class CurrencyConvertViewModel(val currencyRepository:CurrencyRepository) :ViewModel() {
    ...
    var dataFromSever : MutableLiveData<JsonElement>
    private var todoLiveData: MutableLiveData<CurrencyApiResult>
    ...
    init {
        ...
        dataFromSever =  MutableLiveData<JsonElement>()
        todoLiveData =  MutableLiveData<CurrencyApiResult>()
